<div>
    <button id="dt_header_columns" type="button" class="btn btn-sm btn-light me-3" data-kt-menu-trigger="click"
        ...
        <!--end::Svg Icon-->
        <span class="data-action-name">Colonnes</span>
    </button>
    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-bold w-200px"
        data-kt-menu="true" dt-colvis {{ $attributes }}>
    </div>
</div>