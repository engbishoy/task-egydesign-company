...
return[
    'resources' => [
        'company' => [
            'title' => "Company", // main title in the autocomplete for this module
            'actions' => [
                'title' => "Actions",
                'view' => [
                    'title' => "reading",
                ...
                'add' => [
                    'title' => "addition",
                    'description' => "Allows to add a Company"
                ],
                'edit' => [
                    'title' => "edit",
                    'description' => "Allows to make changes to Company"
                ],
                'delete' => [
                    'title' => "deletion",
                    'description' => "Allows to delete the Company"
                ],
                'export' => [
                    'title' => "export",
                    'description' => "Allows the export of the Company table"
                ],
                ...
                'hard_delete' => [
                    ...
                    'description' => "Allows to permanently delete the Company"
                ],
