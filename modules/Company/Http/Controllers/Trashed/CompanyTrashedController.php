...
class CompanyTrashedController extends AppController
{
    ...
    {
        Company::withTrashed()->whereIn('id',$request->ids)->forceDelete();
    ...
    {
        Company::withTrashed()->whereIn('id',$request->ids)->restore();
