            ...
            <div class="group-container mb-5">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="fv-row mb-7">
                            <!--begin::Label-->
                            <label class="control-label fs-6 mb-2">{{ __('user::modal.form.password-label') }}</label>
                            <!--end::Label-->
                            <!--begin::Input-->
...
@javascript(['user_roles' => $userRoles])
@javascript(['user_direct_permissions' => $userDirectPermissions])
<script>
    $(function(){
    /* <=========== Global methods ============> */
    ...
    // add on init
    rolesTagify.addTags(php_to_js['user_roles']);
    ...
    var directPermissionsTagify = new Tagify(document.querySelector('#tagify_direct_permissions'), {
        ...
        enforceWhitelist: true,
        whitelist: arrayDifference(php_to_js['permissions'], rolesPermissionsTagify.value),
        dropdown: {
            closeOnSelect: false,
            // fuzzySearch: false, 
            enabled: 0, // suggest tags after a single character input
    ...
    //initialisation
    directPermissionsTagify.addTags(php_to_js['user_direct_permissions']);
