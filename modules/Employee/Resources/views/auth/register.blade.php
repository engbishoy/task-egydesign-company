...
<html lang="en">
	...
	<body id="kt_body" class="bg-white">
			...
			<div class="d-flex flex-column flex-column-fluid bgi-position-y-bottom position-x-center bgi-no-repeat bgi-size-contain bgi-attachment-fixed" style="background-image: url({{asset('public_assets/temp/progress-hd.png')}})">
				...
				<div class="d-flex flex-center flex-column flex-column-fluid p-10 pb-lg-20">
					...
					<div class="w-lg-500px bg-white rounded shadow-sm p-10 p-lg-15 mx-auto">
						<!--begin::Form-->
						<form class="form w-100" novalidate="novalidate" id="register_form" action="{{ route('employee.register') }}" method="post">
                            @csrf
							<!--begin::Heading-->
							<div class="text-center mb-10">
								<!--begin::Title-->
								<h1 class="text-dark mb-3">{{ __('employee::auth.register') }}</h1>
								<!--end::Title-->
							</div>
							<!--begin::Heading-->
                            @if ($errors->any())
							...
							<div class="fv-row mb-10">
								<!--begin::Label-->
								<label class="form-label control-label fs-6 fw-bolder">{{ __('employee::auth.name') }}</label>
								<!--end::Label-->
								<!--begin::Input-->
							...
							<div class="fv-row mb-10">
								<!--begin::Label-->
								<label class="form-label control-label fs-6 fw-bolder">{{ __('employee::auth.email') }}</label>
								<!--end::Label-->
								<!--begin::Input-->
							...
							<div class="fv-row mb-10">
                                <!--begin::Label-->
                                <label class="form-label control-label fw-bolder fs-6">{{ __('employee::auth.phone') }}</label>
                                <!--end::Label-->
								<!--begin::Input-->
								<input class="form-control form-control-lg" type="text" name="phone" autocomplete="off" />
								<!--end::Input-->
							</div>
                            <!--end::Input group-->
							...
							<div class="fv-row mb-10">
                                <!--begin::Label-->
                                <label class="form-label control-label fw-bolder fs-6">{{ __('employee::auth.password') }}</label>
                                <!--end::Label-->
								<!--begin::Input-->
							...
							<div class="text-center">
								...
								<button type="submit" class="btn btn-lg btn-primary w-100 mb-5">
									<span class="indicator-label">{{ __('employee::auth.connect') }}</span>
									<span class="indicator-progress">{{ __('employee::auth.please_wait') }}...
		...
		<script src="{{asset('/themes/metro8/assets/modules/employee/js/register.js')}}"></script>
