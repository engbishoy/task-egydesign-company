...
<html lang="en">
	...
	<body id="kt_body" class="bg-white">
			...
			<div class="d-flex flex-column flex-column-fluid bgi-position-y-bottom position-x-center bgi-no-repeat bgi-size-contain bgi-attachment-fixed" style="background-image: url({{asset('public_assets/temp/progress-hd.png')}})">
				...
				<div class="d-flex flex-center flex-column flex-column-fluid p-10 pb-lg-20">
					...
					<div class="w-lg-500px bg-white rounded shadow-sm p-10 p-lg-15 mx-auto">
						<!--begin::Form-->
						<form class="form w-100" novalidate="novalidate" id="login_form" action="{{ route('employee.login') }}" method="post">
                            @csrf
							<!--begin::Heading-->
							<div class="text-center mb-10">
								<!--begin::Title-->
								<h1 class="text-dark mb-3">{{ __('employee::auth.title') }}</h1>
								<!--end::Title-->
							</div>
							<!--begin::Heading-->
                            @if ($errors->any())
							...
							<!--end::Input group-->
							<div class="row mb-10">
								<label class="form-check form-check-custom form-check-solid col-sm-7">
								...
								<label class="form-check form-check-custom form-check-solid col-sm-5">
									<a href="{{route('employee.register.show')}}" class="form-check-label">
		...
		<script src="{{asset('/themes/metro8/assets/modules/employee/js/login.js')}}"></script>
